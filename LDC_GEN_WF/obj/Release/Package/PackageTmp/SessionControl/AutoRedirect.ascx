<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutoRedirect.ascx.cs" Inherits="LDC_GEN_WF.SessionControl.AutoRedirect" %>
...
<script type="text/javascript">
    ...
    function Redirect() {
        //window.location.replace(window.location.href.substring(window.location.href.lastIndexOf("/")+1))
        //window.location.replace("Login.aspx");
        //(window.location.href.substring(window.location.href.lastIndexOf("/")+1))
        var aLoc = window.location.href;
        var nLoc = aLoc.replace(aLoc, "Login.aspx");
        window.location.replace(window.location.href, "http://ncm-uat-srv:8078/login.aspx");
