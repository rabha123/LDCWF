<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="unAuthorize.aspx.cs" Inherits="LDC_GEN_WF.View.unAuthorize" %>
...
<body>
 <table class="style1" style="border-style: groove">
  ...
  <%--    <tr>
         <td>
             <a href="http://ncm-uat-srv:8078/login.aspx" ><h1 style="margin: 0px 0px 10px; padding: 0px; font-size: 28px; font-weight: normal; color: rgb(0, 153, 0); font-family: 'Helvetica Neue', HelveticaNeue, Helvetica, Arial, sans-serif; font-style: normal; font-variant: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);">
                        Login</h1></a>
         </td>
     </tr>--%>
    </table>
